...
namespace DCExternalSite.Web
{
    ...
    [EnableClientAccess()]
    public class DCService : LinqToEntitiesDomainService<ASPNETDBEntities>
    {
        ...
        public IQueryable<Examinations> GetExaminations()
        {
            return this.ObjectContext.Examinations;
        }
        ...
        public IQueryable<ExaminationTypes> GetExaminationTypes()
        {
